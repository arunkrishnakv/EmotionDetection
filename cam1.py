...
if f==1:
  ...
  def xno():
    return render_template("xno.html",value=i,f=image_to_test,path=pat)
...
if i == 0 and f==0:
  ...
  def angry():
    return render_template("angry.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print("angry")
if i == 1 and f==0:
  @app.route('/')
  def disgust():
    return render_template("xdisgust.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print('disgust')
if i == 2 and f==0:
  @app.route('/')
  def happy():
    return render_template("xhappy.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print('happy')
if i == 3 and f==0:
  @app.route('/')
  def neutral():
    return render_template("xneutral.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print('neutral')
if i == 4 and f==0:
  @app.route('/')
  def sad():
    return render_template("xsad.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print('sad')
if i == 5 and f==0:
  @app.route('/')
  def surprise():
    return render_template("xsurprise.html",value=i,f=image_to_test,path=pat)
  #app.run(debug=True)
  print('surprise')
